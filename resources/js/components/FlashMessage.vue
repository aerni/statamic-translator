    ...
    >
        <div class="flex items-center">
            <div class="flex-shrink-0">
                <svg v-if="type === 'alert'" class="w-6 h-6 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                ...
                <svg v-if="type === 'info'" class="w-6 h-6 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/>
                </svg>
                <div v-if="type === 'loading'" class="flex items-center justify-center w-6 h-6">
                    <span class="icon icon-circular-graph animation-spin"></span>
                </div>
                <svg v-if="type === 'success'" class="w-6 h-6 text-green-400" fill="currentColor" viewBox="0 0 20 20">
...
<style scoped src="../../dist/css/translator.css"></style>
